...
public class AddWayPointDialog extends JDialog {
	...
	JTextField wayPointNoT, latitudeT, longitudeT, leadTimeT, headingT, forwardDraftT, afterDratfT, convertLeadTimeTF;
	...
	public AddWayPointDialog(Frame frame, String name) {
	...
	public JDialog createDialog() {
		...
		JLabel index = new JLabel(String.valueOf(this.row), JLabel.LEFT);
		...
		convertLeadTimeT = new JLabel("0h 00m", JLabel.LEFT);
		...
		afterDratfT = new JFormattedTextField(TextNumberFormatter.DoubleFormatter());
		afterDratfT.setPreferredSize(new Dimension(300, 20));
		afterDratfT.setName("AftDraft");
		settingPanel.add(afterDratfT);
